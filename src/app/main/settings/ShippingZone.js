...
import { addShippingZoneSettings } from 'app/store/settingSlice';
...
const schema = yup.object().shape({
  ...
  methodDescription: yup.string().required('You must enter methodDescription'),
...
const defaultValues = { hideShippingCost: false };
...
export const ShippingZone = () => {
  ...
  function onSubmit(data) {
    dispatch(addShippingZoneSettings(data));
  }
  return (
    <div className='p-32'>
      <Typography className=' title '>{`Settings -> Shipping Zone -> Everywhere`}</Typography>
